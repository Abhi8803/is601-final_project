...
app = FastAPI(
    ...
    version="1.0.0",
    docs_url=None,   # disable default /docs so we can serve our dark version
    redoc_url=None,
)
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .swagger-ui .info { background: #0a0a0a; padding: 24px 0 16px; }
    .swagger-ui .info .title { color: #f0ece0; font-size: 28px; }
    .swagger-ui .info p, .swagger-ui .info li { color: #888; }
    .swagger-ui .info a { color: #e8834a; }
    ...
    .swagger-ui .opblock .opblock-summary-path__deprecated { color: #666; }
    ...
    .swagger-ui input[type=text], .swagger-ui input[type=password], .swagger-ui textarea, .swagger-ui select {
      background: #1a1a1a; border: 1px solid #2a2a2a; color: #d4d0c8; border-radius: 4px;
    }
    ...
    .swagger-ui .btn.authorize { background: transparent; border-color: #22c55e; color: #22c55e; }
    ...
    .swagger-ui .microlight { background: #111 !important; color: #e8834a; }
    .swagger-ui .highlight-code { background: #111; }
    .swagger-ui .highlight-code code { color: #d4d0c8; }
    .swagger-ui pre.version { background: #1a1a1a; color: #888; }
    ...
    /* misc */
    .swagger-ui .loading-container .loading::after { border-color: #e8834a transparent #e8834a transparent; }
    .swagger-ui svg { fill: #888; }
    .swagger-ui .expand-methods svg, .swagger-ui .expand-operation svg { fill: #666; }
